        ...
        {showCode && (
          <div className="bg-slate-950 border border-slate-800 rounded-xl p-4 overflow-hidden relative group">
            <button 
               ...
               className="absolute top-4 right-4 bg-slate-800 hover:bg-slate-700 text-slate-300 p-2 rounded-lg text-xs font-semibold opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none transition-opacity"
            >
               Copiar Código
            </button>
