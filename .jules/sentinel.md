...
**Prevention:** Role assignment endpoints must enforce strict hierarchy validation for *all* privileged roles, ensuring the actor's role strictly outranks or equals the target role they are assigning or modifying.
