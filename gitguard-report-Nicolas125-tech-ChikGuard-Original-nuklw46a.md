...
**Scan:** `cmsszpk8b00d8mo99nuklw46a` · MANUAL · branch `main` · commit `8bf370e901ca`
**Status:** COMPLETED · **Executado em:** 2026-08-14T13:35:50.395Z · **Concluído em:** 2026-08-14T13:38:40.711Z
**Relatório gerado em:** 2026-08-14T13:40:43.138Z por GitGuard

## Instruções para a IA que for corrigir isto

- Repositório alvo: Nicolas125-tech/ChikGuard-Original, branch "main", commit 8bf370e901caa3f463e47f99c2a9b3dd2da5c916. Aplique as correções diretamente nesse checkout.
...
- **Total de findings:** 146
- **Por severidade:** HIGH: 61 · MEDIUM: 73 · LOW: 12
- **Por scanner:** SEMGREP: 20 · GITLEAKS: 9 · TRIVY: 117
...
**Ação recomendada:** atualizar de `1.16.1` para `a versão mais recente` (ou superior).
...
**Ação recomendada:** atualizar de `3.4.6` para `a versão mais recente` (ou superior).
