    ...
    mock_logs = [
        {
            ...
            "detections": [{"id": 1, "class": 0, "confidence": 0.9, "smoothed_centroid": [100, 150]}]
        },
        {
            "frame": 2,
            "timestamp": 1716634801.0,
            "detections": [{"id": 2, "class": 0, "confidence": 0.85, "smoothed_centroid": [110, 160]}]
        }
    ]
...
async def test_sync_worker_recovery(temp_files):
    ...
    initial_backlog = [{"track_id": 99, "class_id": 0, "confidence": 0.99, "pos_x": 50, "pos_y": 50, "frame_number": 10, "detected_at": "2026-05-25 12:00:00"}]
