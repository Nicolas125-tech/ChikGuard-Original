...
def create_auth_blueprint(deps):
    ...
    def accounts_users():
        ...
        try:
            ...
            logging.error("Erro em accounts_users: %s", e)
    ...
    def accounts_user_update(account_id):
        ...
        try:
            ...
            logging.error("Erro em accounts_user_update: %s", e)
            return jsonify({"error": "Erro interno no servidor"}), 500
    ...
    def accounts_user_delete(account_id):
        ...
        try:
            ...
            logging.error("Erro em accounts_user_delete: %s", e)
            return jsonify({"error": "Erro interno no servidor"}), 500
    ...
    def admin_pending_users():
        ...
        try:
            ...
            logging.error("Erro em admin_pending_users: %s", e)
            return jsonify({"error": "Erro interno no servidor"}), 500
    ...
    def admin_approve_user():
        ...
        try:
            ...
            logging.error("Erro em admin_approve_user: %s", e)
            return jsonify({"error": "Erro interno no servidor"}), 500
