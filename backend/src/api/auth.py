...
def create_auth_blueprint(deps):
    ...
    def accounts_users():
        ...
        try:
            ...
            logging.getLogger(__name__).error(f"Erro ao buscar profiles: {e}")
    ...
    def accounts_user_update(account_id):
        ...
        try:
            ...
            logging.getLogger(__name__).error(f"Erro ao atualizar conta {account_id}: {e}")
            return jsonify({"error": "Internal server error"}), 500
    ...
    def accounts_user_delete(account_id):
        ...
        try:
            ...
            logging.getLogger(__name__).error(f"Erro ao excluir conta {account_id}: {e}")
            return jsonify({"error": "Internal server error"}), 500
    ...
    def admin_pending_users():
        ...
        try:
            ...
            logging.getLogger(__name__).error(f"Erro ao buscar usuarios pendentes: {e}")
            return jsonify({"error": "Internal server error"}), 500
    ...
    def admin_approve_user():
        ...
        try:
            ...
            logging.getLogger(__name__).error(f"Erro ao aprovar usuario: {e}")
            return jsonify({"error": "Internal server error"}), 500
