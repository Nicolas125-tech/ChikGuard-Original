...
class RespiratoryDiseaseClassifier:
    ...
    def _load_model(self) -> Optional[Any]:
        ...
        """
        logger.info(f"Carregando modelo de classificação de áudio leve da Borda em: {self.model_path}")
    ...
    def analyze_and_emit(self, audio_buffer: np.ndarray, sr: int, camera_zone: str, broker_client=None):
        """
