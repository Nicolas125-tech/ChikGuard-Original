...
ALTER TABLE public.camera DROP CONSTRAINT IF EXISTS uq_camera_id;
...
BEGIN
    FOR t_name IN
        SELECT tablename FROM pg_tables WHERE schemaname = 'public' AND tablename IN ('tenant', 'account', 'role_permission', 'reading', 'bird_snapshot', 'bird_identity', 'bird_track_point', 'event_log', 'sensor_reading', 'batch', 'weight_estimate', 'acoustic_reading', 'thermal_anomaly', 'energy_usage_daily', 'audit_log', 'sync_queue_item', 'batch_logbook', 'push_token', 'camera')
    LOOP
        EXECUTE format('DROP POLICY IF EXISTS "Permitir leitura autenticada" ON public.%I', t_name);
        EXECUTE format('CREATE POLICY "Permitir leitura autenticada" ON public.%I FOR SELECT TO authenticated USING (true)', t_name);

        EXECUTE format('DROP POLICY IF EXISTS "Permitir insercao autenticada" ON public.%I', t_name);
        ...
        EXECUTE format('DROP POLICY IF EXISTS "Permitir atualizacao autenticada" ON public.%I', t_name);
        EXECUTE format('CREATE POLICY "Permitir atualizacao autenticada" ON public.%I FOR UPDATE TO authenticated USING (true)', t_name);

        EXECUTE format('DROP POLICY IF EXISTS "Permitir delecao autenticada" ON public.%I', t_name);
...
DO $$ BEGIN ALTER TABLE public.account DROP CONSTRAINT IF EXISTS fk_account_tenant; EXCEPTION WHEN OTHERS THEN END $$;
...
DO $$ BEGIN ALTER TABLE public.reading DROP CONSTRAINT IF EXISTS fk_reading_tenant; EXCEPTION WHEN OTHERS THEN END $$;
...
DO $$ BEGIN ALTER TABLE public.bird_snapshot DROP CONSTRAINT IF EXISTS fk_snapshot_tenant; EXCEPTION WHEN OTHERS THEN END $$;
...
DO $$ BEGIN ALTER TABLE public.bird_identity DROP CONSTRAINT IF EXISTS fk_identity_tenant; EXCEPTION WHEN OTHERS THEN END $$;
...
DO $$ BEGIN ALTER TABLE public.bird_track_point DROP CONSTRAINT IF EXISTS fk_track_tenant; EXCEPTION WHEN OTHERS THEN END $$;
...
DO $$ BEGIN ALTER TABLE public.event_log DROP CONSTRAINT IF EXISTS fk_event_tenant; EXCEPTION WHEN OTHERS THEN END $$;
...
DO $$ BEGIN ALTER TABLE public.sensor_reading DROP CONSTRAINT IF EXISTS fk_sensor_tenant; EXCEPTION WHEN OTHERS THEN END $$;
...
DO $$ BEGIN ALTER TABLE public.batch DROP CONSTRAINT IF EXISTS fk_batch_tenant; EXCEPTION WHEN OTHERS THEN END $$;
...
DO $$ BEGIN ALTER TABLE public.weight_estimate DROP CONSTRAINT IF EXISTS fk_weight_tenant; EXCEPTION WHEN OTHERS THEN END $$;
...
DO $$ BEGIN ALTER TABLE public.acoustic_reading DROP CONSTRAINT IF EXISTS fk_acoustic_tenant; EXCEPTION WHEN OTHERS THEN END $$;
...
DO $$ BEGIN ALTER TABLE public.thermal_anomaly DROP CONSTRAINT IF EXISTS fk_thermal_tenant; EXCEPTION WHEN OTHERS THEN END $$;
...
DO $$ BEGIN ALTER TABLE public.energy_usage_daily DROP CONSTRAINT IF EXISTS fk_energy_tenant; EXCEPTION WHEN OTHERS THEN END $$;
...
DO $$ BEGIN ALTER TABLE public.audit_log DROP CONSTRAINT IF EXISTS fk_audit_tenant; EXCEPTION WHEN OTHERS THEN END $$;
...
DO $$ BEGIN ALTER TABLE public.sync_queue_item DROP CONSTRAINT IF EXISTS fk_sync_tenant; EXCEPTION WHEN OTHERS THEN END $$;
...
DO $$ BEGIN ALTER TABLE public.batch_logbook DROP CONSTRAINT IF EXISTS fk_logbook_tenant; EXCEPTION WHEN OTHERS THEN END $$;
...
DO $$ BEGIN ALTER TABLE public.push_token DROP CONSTRAINT IF EXISTS fk_push_tenant; EXCEPTION WHEN OTHERS THEN END $$;
...
DO $$ BEGIN ALTER TABLE public.camera DROP CONSTRAINT IF EXISTS fk_camera_tenant; EXCEPTION WHEN OTHERS THEN END $$;
...
DO $$ BEGIN ALTER TABLE public.event_log DROP CONSTRAINT IF EXISTS fk_event_camera; EXCEPTION WHEN OTHERS THEN END $$;
...
DO $$ BEGIN ALTER TABLE public.sensor_reading DROP CONSTRAINT IF EXISTS fk_sensor_camera; EXCEPTION WHEN OTHERS THEN END $$;
...
DO $$ BEGIN ALTER TABLE public.batch DROP CONSTRAINT IF EXISTS fk_batch_camera; EXCEPTION WHEN OTHERS THEN END $$;
...
DO $$ BEGIN ALTER TABLE public.weight_estimate DROP CONSTRAINT IF EXISTS fk_weight_camera; EXCEPTION WHEN OTHERS THEN END $$;
...
DO $$ BEGIN ALTER TABLE public.acoustic_reading DROP CONSTRAINT IF EXISTS fk_acoustic_camera; EXCEPTION WHEN OTHERS THEN END $$;
...
DO $$ BEGIN ALTER TABLE public.thermal_anomaly DROP CONSTRAINT IF EXISTS fk_thermal_camera; EXCEPTION WHEN OTHERS THEN END $$;
...
DO $$ BEGIN ALTER TABLE public.energy_usage_daily DROP CONSTRAINT IF EXISTS fk_energy_camera; EXCEPTION WHEN OTHERS THEN END $$;
...
DO $$ BEGIN ALTER TABLE public.batch_logbook DROP CONSTRAINT IF EXISTS fk_logbook_camera; EXCEPTION WHEN OTHERS THEN END $$;
